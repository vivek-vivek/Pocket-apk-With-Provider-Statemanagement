...
import 'package:budgetory_v1/view/all_transaction_screen/widgets/edit.dart';
import 'package:budgetory_v1/view/all_transaction_screen/widgets/search.dart';
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(bottom: 10, right: 25, left: 40),
                child: Container(
                  height: 30.00,
...
// ~-------------------------------------------------------------------End--------------------------------------------------
      ...
      PlutoMenuItem(
        ...
        children: [
          ...
          PlutoMenuItem(title: 'Monthly', children: [
            plutoMenuItem('January', DateTime.january),
            plutoMenuItem('February', DateTime.february),
            plutoMenuItem('March', DateTime.march),
            plutoMenuItem('April', DateTime.april),
            plutoMenuItem('May', DateTime.may),
            plutoMenuItem('Jun', DateTime.june),
            plutoMenuItem('July', DateTime.july),
            plutoMenuItem('August', DateTime.august),
            plutoMenuItem('September', DateTime.september),
            plutoMenuItem('October', DateTime.october),
            plutoMenuItem('November', DateTime.november),
            plutoMenuItem('December', DateTime.december),
          ])
        ],
      ),
    ];
  ...
  PlutoMenuItem plutoMenuItem(String tittle, month) {
    return PlutoMenuItem(
      title: tittle,
      onTap: () {
        if (categoryDropValue == filterArray.filterItemsArray[0]) {
          monthlyFilter(
              month: month, notifier: Filter.instance.allMonthlyNotifier.value);
        } else if (categoryDropValue == filterArray.filterItemsArray[1]) {
          monthlyFilter(
              month: month,
